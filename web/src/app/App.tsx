...
import { Login, StudentDashboard, StudentTimetable, StudentAttendance, AttendanceScan, Assignments, Profile, Result } from '../pages/student';
...
export function App() {
  ...
  if (role !== 'student' && ['dashboard', 'schedule', 'attendance', 'assignments', 'profile', 'result'].includes(route)) { navigate('activities'); return <Activities />; }
