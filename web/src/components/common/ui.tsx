...
export const studentNavigation = [['dashboard', 'Home', 'home'], ['schedule', 'Timetable', 'calendar_month'], ['assignments', 'Tasks', 'task_alt'], ['profile', 'Profile', 'person']] as const;
export const adminNavigation = [['exams', 'Exams', 'quiz'], ['documents', 'Paperwork', 'description'], ['activities', 'Activities', 'celebration'], ['timetable', 'Timetable', 'calendar_month'], ['timetable-settings', 'Timetable setup', 'tune']] as const;
