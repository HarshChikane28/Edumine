...
export const studentNavigation = [['dashboard', 'Home', 'home'], ['schedule', 'Timetable', 'calendar_month'], ['attendance', 'Attendance', 'fact_check'], ['assignments', 'Tasks', 'task_alt']] as const;
export const adminNavigation = [['exams', 'Exams', 'quiz'], ['student-management', 'Students', 'group'], ['documents', 'Paperwork', 'description'], ['activities', 'Activities', 'celebration'], ['admin-attendance', 'Attendance', 'fact_check'], ['timetable', 'Timetable', 'calendar_month'], ['timetable-settings', 'Timetable setup', 'tune']] as const;
