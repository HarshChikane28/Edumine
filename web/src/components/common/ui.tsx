...
export const adminNavigation = [['exams', 'Exams', 'quiz'], ['documents', 'Paperwork', 'description'], ['activities', 'Activities', 'celebration'], ['timetable', 'Timetable', 'calendar_month']] as const;
